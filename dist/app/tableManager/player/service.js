...
class Service {
    ...
    emit(sEventName, oData = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!sEventName)
                return false;
            if (this.sSocketId)
                global.io.to(this.sSocketId).emit(this.iBattleId, h.stringify({ sTaskName: sEventName, oData }));
    ...
    assignDrawPenalty(oTable) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield h.delay(300 * aCard.length);
        });
    }
    takeTurn(oTable) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    assignWildCardColorTimerExpired(oTable) {
        return __awaiter(this, void 0, void 0, function* () {
            let randomColor = h.randomizeArray(["red", "green", "blue", "yellow"]);
