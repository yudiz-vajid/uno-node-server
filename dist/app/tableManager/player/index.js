    ...
    drawCard(oData, oTable, callback) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!aCard || aCard === undefined) {
                callback({ oData: {}, status: util_1.response.SERVER_ERROR });
                return (_a = (log.error(`${h.now()} no card found for iCardId: ${oData.iCardId}`) && null)) !== null && _a !== void 0 ? _a : false;
            }
    ...
    decalreUno(oData, oTable, callback) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (eligibleUno && playableCards.length) {
                ...
                return (_a = (log.silly(`${h.now()} ${this.iPlayerId} has not valid uno.`) && null)) !== null && _a !== void 0 ? _a : false;
            }
        });
    }
