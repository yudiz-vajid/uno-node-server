...
class TableManager {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (['assignTurnTimerExpired', 'assignGraceTimerExpired', 'drawCard', 'discardCard', 'decalreUno'].includes(sTaskName)) {
                if (!oPlayer) {
                    ...
                    return (_a = (log.warn(`${h.now()} oPlayer not found in table. { iBattleId : ${iBattleId}, iPlayerId : ${iPlayerId} }`) && null)) !== null && _a !== void 0 ? _a : false;
                }
                if (oTable.toJSON().eState !== 'running' && ['drawCard', 'discardCard'].includes(sTaskName)) {
                    ...
                    return (_b = (log.warn(`${h.now()} Table is not in running state. { iBattleId : ${iBattleId}, eState : ${oTable.toJSON().eState} }`) && null)) !== null && _b !== void 0 ? _b : false;
                }
                if (!oTable.hasValidTurn(iPlayerId) && ['drawCard', 'discardCard'].includes(sTaskName)) {
                    ...
                    return (_c = (log.silly(`${h.now()} ${iPlayerId} has not valid turn.`) && null)) !== null && _c !== void 0 ? _c : false;
                }
            }
            switch (sTaskName) {
                case 'distributeCard':
    ...
    static createTable(oData) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const sRedisSetResponse = yield redis.client.json.SET(h.getTableKey(oTableWithParticipant.iBattleId), '.', oTableWithParticipant);
    ...
    static createPlayer(oPlayer) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const sRedisSetResponse = yield redis.client.json.SET(h.getPlayerKey(oPlayer.iBattleId, oPlayer.iPlayerId), '.', oPlayer);
                if (!sRedisSetResponse)
                    return null;
    ...
    static getTable(iBattleId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const oTableData = (yield redis.client.json.GET(h.getTableKey(iBattleId)));
                if (!oTableData)
                    return null;
                const aPromise = [];
