...
function pathFinderInit() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            lib_pathfinder_node_1.default.initialize({ appName: 'Uno', protosToLoad: grpc_1.default, loadOpts, promisify: true });
            ...
            const resp = yield client.authenticate().sendMessage({ requestId: 'req_1', authToken: 'authToken_1' });
